...
$(document).ready(function() {
    ...
    $('<button id="join-button" style="background-color: #424242; color: white; padding: 10px 20px; border-radius: 5px; border: 1px solid yellow; cursor: pointer; margin: 10px; font-family: \'Lucida Console\', monospace;">Join</button>')
